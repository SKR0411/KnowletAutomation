...
# === SETTINGS ===
BASE_URL = "https://knowlet.netlify.app"  # Change this to your site’s base URL
ROOT_DIR = "/storage/emulated/0/.hidden_files/workspace/web/knowlet"  # Folder where your HTML files are located
  ...
  for root, _, files in os.walk(ROOT_DIR):
    for file in files:
      if file.endswith(".html"):
        ...
        print(url.removeprefix(BASE_URL) + '  ✅')
